...
The datafile for the climate data can be downloaded at 
https://drive.google.com/file/d/0B-27Rl4X1ULEQ2tMWUJtRVFkQXM/view?usp=sharing

```{r}
#####################
#Vap - vapor pressure
#####################
vap.full <- open.nc('cru_ts3.23.2011.2014.vap.dat.nc', write=FALSE)
...
#Wet - Wet days
#####################
wet.full <- open.nc('cru_ts3.23.01.2011.2014.wet.dat.nc', write=FALSE)
...
#####################
dtr.full <- open.nc('cru_ts3.23.2011.2014.dtr.dat.nc', write=FALSE)
...
#####################
pet.full <- open.nc('cru_ts3.23.2011.2014.pet.dat.nc', write=FALSE)
...
#####################
pre.full <- open.nc('cru_ts3.23.2011.2014.pre.dat.nc', write=FALSE)
...
#tmn - min Temp
#####################
tmn.full <- open.nc('cru_ts3.23.2011.2014.tmn.dat.nc', write=FALSE)
...
#tmp - mean Temp
#####################
tmp.full <- open.nc('cru_ts3.23.2011.2014.tmp.dat.nc', write=FALSE)
...
#tmx - max Temp
###############
tmx.full <- open.nc('cru_ts3.23.2011.2014.tmx.dat.nc', write=FALSE)
...
guinea_weekly_cases <- read.csv('guinea_cases_long.csv')
...
SL_weekly_cases <- read.csv('SL_cases_long.csv')
...
Liberia_weekly_cases <- read.csv('Liberia_cases_long.csv')
